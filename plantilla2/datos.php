...
function servicios()
{
    ...
    $servicios_ARRAY = [
        ...
        array(
            ...
            "DESCRIPCION2" => "Instalaciones de tableros, acometida electrica,
            puntos eléctricos, reordenamiento de cableado,
            luminarias, reubicaciones",
            "DETALLE1" => "DETALLE1",
            "DETALLE1_DESC" => "descripcion del detalle",
            "DETALLE2" => "DETALLE2",
        ...
        array(
            ...
            etc.",
            "DESCRIPCION2" => "Soldadura en cobre, aluminio y acero inoxidable,
            fabricación de estructuras metálicas, techados,
            galpones, instalación de cercos y mallas metálicas,
            etc.",
            "DETALLE1" => "DETALLE1",
        ...
        array(
            ...
            ",
            "DESCRIPCION2" => "Limpieza en todo tipo de área, esterilización de
            área, se cuenta con hidrolavadora, desengrasante e
            implementos de limpieza (oficinas, interiores,
            Talleres, Grúas gantry, grúas MHC, grúas Stacker,
            corte de maleza, terrenos y patios.) etc.…
        ...
        array(
            ...
            "DESCRIPCION2" => "Aceras, iluminación vial, tráfico y peatonales,
            señalizaciones, trabajo de pintura en toda área y
            tipo (anticorrosivo, epóxica, látex, trafico,
            impermeable, satinado, aqua) etc",
            "DETALLE1" => "DETALLE1",
        ...
        array(
            ...
            remodelaciones) etc…",
            "DESCRIPCION2" => "Cielo raso, fibra cemento, gypsum (obras nuevas y
            remodelaciones) etc…",
            "DETALLE1" => "DETALLE1",
            "DETALLE1_DESC" => "descripcion del detalle",
            "DETALLE2" => "DETALLE2",
        ...
        array(
            ...
            "DESCRIPCION2" => "Mampostería, aluminio y vidrio, enchapes,
            revestimientos, Señaléticas (Guardavías, reductores
            de velocidad), áreas verdes, adoquinado, etc…",
            "DETALLE1" => "DETALLE1",
            "DETALLE1_DESC" => "descripcion del detalle",
        ...
        array(
            ...
            reubicación, etc…",
            "DESCRIPCION2" => "Instalación, mantenimiento preventivo,
            predictivo y correctivo, suministro,
            reubicación, etc…",
            "DETALLE1" => "DETALLE1",
            "DETALLE1_DESC" => "descripcion del detalle",
        ...
        array(
            ...
            "DESCRIPCION2" => "Instalación de señalética de prohibición,
            obligación, sistema contraincendios, carteleras, etc.",
            "DETALLE1" => "DETALLE1",
            "DETALLE1_DESC" => "descripcion del detalle",
            "DETALLE2" => "DETALLE2",
    ...
    $ARRAY_ACERCA = [
        ...
        array(
            array(
                "EMP1" => "NOMBRE 1",
                "EMP1_CARGO" => "CARGO 1",
                "EMP1_IMG" => "assets/images/team/team1.jpg",
                "DESC" => "descricion"
            ),
            array(
                "EMP1" => "NOMBRE 2",
                "EMP1_CARGO" => "CARGO 1",
                "EMP1_IMG" => "assets/images/team/team2.jpg",
                "DESC" => "descricion"
                ...
                "EMP1" => "NOMBRE 3",
                "EMP1_CARGO" => "CARGO 3",
                "EMP1_IMG" => "assets/images/team/team3.jpg",
                "DESC" => "descricion"
                ...
                "EMP1" => "NOMBRE 4",
                "EMP1_CARGO" => "CARGO 4",
                "EMP1_IMG" => "assets/images/team/team4.jpg",
                "DESC" => "descricion"
...
function INDEX()
{
    ...
    $INFO = [
        array(
            "TELF" => "(593) 0969786231",
            "EMAIL" => "email@armantenimientos.com",
            "CERTIFICADO" => "ISO 9001",
            "WHATS" => "https://wa.me/5930969786231 ",
            "DIRECCION" => "AV 12345677",
            "FACEB" => "#!",
            "INSTA" => "#!",
            "TIK" => "#!",
        )
