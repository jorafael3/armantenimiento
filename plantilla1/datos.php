...
function CABECERA_TOP_BAR()
{

    $DATOS = [
        array(
            "HORARIO" => "Guayaquil - Ecuador",
            "FACEBOOK" => "#!",
            "TIKTOK" => "#!",
            "INSTAGRAM" => "#!",
        )
...
function SLIDER()
{
    ...
    $DATOS = [
        array(
            "TEXTO1" => "",
            "TEXTO2" => "8 año de excelencia",
            "TEXTO3" => "industria de la construccion",
            "IMAGEN" => "assets_p2/assets/images/slider-main/bg1.jpg",
            "LINKS" => [
                array(
                    "PAGINA" => "servicios.php",
                    "TEXTO" => "Nuestros servicios",
                ), array(
                    "PAGINA" => "contactos.php",
                    "TEXTO" => "Contactanos",
                ),
            ]
        ),
        array(
            "TEXTO1" => "Servicio de clase",
            "TEXTO2" => "Cuando el servicio importa",
            "TEXTO3" => "tu elección es simple",
            "IMAGEN" => "assets_p2/assets/images/slider-main/bg2.jpg",
            "LINKS" => [
                array(
                    "PAGINA" => "servicios.php",
                    "TEXTO" => "Nuestros servicios",
            ...
            "TEXTO1" => "Conocenos",
            "TEXTO2" => "nosotros creemos en la sostenibilidad",
            "TEXTO3" => "nosotros nos ocuparemos",
            "IMAGEN" => "assets_p2/assets/images/slider-main/bg3.jpg",
            "LINKS" => [
                array(
                    "PAGINA" => "contactos.php",
                    "TEXTO" => "contactanos",
